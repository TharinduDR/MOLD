...
from experiments.util.print_stat import print_information_multi_class
...
print_information_multi_class(dev, "predictions", "labels")
dev.to_csv(os.path.join(TEMP_DIRECTORY, "level_3_pred.tsv"), header=True, sep='\t', index=False, encoding='utf-8')
